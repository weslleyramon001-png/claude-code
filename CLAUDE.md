...
> Última atualização: 2026-06-20 (JARBAS UI — tema + export; backend — 5 ferramentas + /status + /export)
...
- [x] Landing Page completa do Pack de Planilhas (copy pronta para Kiwify/Hotmart) (17/06/2026)
- [x] Sequência de 7 emails criada — funil completo pronto para MailerLite (17/06/2026)
- [x] Banco de 45 Hooks Virais para Instagram criado (5 categorias) (17/06/2026)
- [x] 5 Scripts de Reels prontos para gravar (com hook + desenvolvimento + CTA) (17/06/2026)
...
- [x] JARBAS Desktop — instalar-windows.ps1 + claude-settings.json + 12 MCP servers (19/06/2026)
- [x] JARBAS Backend — 5 novas ferramentas: system_info, run_command, list_files, read_file, write_file (20/06/2026)
- [x] JARBAS Backend — endpoint GET /status (saúde dos serviços) + GET /export/{session_id} (20/06/2026)
- [x] JARBAS UI — seletor de tema 4 cores (roxo/azul/verde/vermelho) persistido em localStorage (20/06/2026)
- [x] JARBAS UI — botão "Exportar Conversa" baixa histórico em .txt (20/06/2026)
